...
import { useSupplierInvoice } from "@/utils/hooks/useSupplierInvoice";
...
export default function SupplierInvoice() {
  ...
  const {
    ...
    totalPages,
    isLoading
  } = useSupplierInvoice({ useMock: true });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Supplier Invoices</h1>
          <p className="text-gray-600">Manage and track all Supplier invoices</p>
        </div>
